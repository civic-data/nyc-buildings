...
typedict = {'Job_number':'string', 'Owner\xe2\x80\x99s_House_State':'string', 'Owners_House_State':'string', 'Owners_First_Name':'string','Permit_Status':'string','Residential':'string','Street_Name':'string','Owners_House_number':'string','Permit_Sequence_number':'string','Owners_Business_Type':'string','Lot':'string','Owners_Last_Name':'string','Act_as_Superintendent':'string','Owners_Phone_number':'string','Self_Cert':'string','HIC_License':'string','Filing_Status':'string','Owners_House_Street_Name':'string','Bldg_Type':'string','Permittees_Last_Name':'string','Permit_Subtype':'string','Owners_Business_Name':'string','Special_District_1':'string','Filing_Date':'timestamp','Permittees_Other_Title':'string','Special_District_2':'string','House_number':'string','Site_Safety_Mgrs_First_Name':'string','Permittees_Business_Name':'string','Non_Profit':'string','Superintendent_Business_Name':'string','Bin_number':'string','Site_Safety_Mgrs_Last_Name':'string','Issuance_Date':'timestamp','Work_Type':'string','Job_Type':'string','Community_Board':'string','Site_Safety_Mgr_Business_Name':'string','Permittees_Phone_number':'string','Permittees_License_number':'string','Permittees_License_Type':'string','Oil_Gas':'string','Site_Fill':'string','Block':'string', 'Owners_House_Zip_Code':'string', 'Owner\xe2\x80\x99s_House_Zip_Code':'string', 'DOBRunDate':'timestamp','Expiration_Date':'timestamp','Permittees_First_Name':'string','Permit_Type':'string','Job_doc_number':'string','Superintendent_First_n_Last_Name':'string', 'Owners_House_City':'string', 'Owner\xe2\x80\x99s_House_City':'string', 'BOROUGH':'string','Job_Start_Date':'timestamp','Zip_Code':'string'}
